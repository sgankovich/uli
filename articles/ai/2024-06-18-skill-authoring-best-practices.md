...
source: "https://docs.claude.com/en/agents-and-tools/agent-skills/authoring"
author: "Anthropic"
category: "ai"
tags: [ai, claude, skills, authoring, best-practices, documentation, development, agents]
---

# Skill Authoring Best Practices

> **Source:** [Claude Documentation - Skill Authoring](https://docs.claude.com/en/agents-and-tools/agent-skills/authoring)  
> **Added:** 2024-06-18

Learn how to write effective Skills that Claude can discover and use successfully.

For conceptual background on how Skills work, see the [Skills overview](https://docs.claude.com/en/agents-and-tools/agent-skills/overview).
...
The [context window](https://docs.claude.com/en/build-with-claude/context-windows) is a public good. Your Skill shares the context window with everything else Claude needs to know, including:
- The system prompt
...
For complete Skill structure details, see the [Skills overview](https://docs.claude.com/en/agents-and-tools/agent-skills/overview#skill-structure).
...
4. **Review Claude A's suggestions:** Claude A might suggest reorganizing to make rules more prominent
...
Skills run in the code execution environment with platform-specific limitations. List required packages in your SKILL.md and verify they're available in the code execution tool documentation.
